...
function NavAccount(props) {
    ...
    return (
        <div className={`${styles.nav} ${navBlack || buttonMenu || props.type == "Profil" ? styles.nav__black : ""} ${buttonMenu && styles.parent} ${props.type == "Home" || props.type == "Login" && styles.nav__fixed}`}>
            {
                props.type == "Account" ?
